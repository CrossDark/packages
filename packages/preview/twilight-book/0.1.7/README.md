...
```typ
#import "@preview/twilight-book:0.1.77": *
...
```shell
git clone https://github.com/CrossDark/TwilightBook.git "$HOME/Library/Application Support/typst/packages/local/twilight-book/0.1.7"
```
